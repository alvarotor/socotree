...
export const BerlinDePageTemplate = ({ howitworks, faq }) => (
  <>
...
BerlinDePageTemplate.propTypes = {
  howitworks: PropTypes.object,
  faq: PropTypes.array,
}

const BerlinDePage = ({ data }) => {
...
export default BerlinDePage

export const pageQuery = graphql`
  query BerlinDePageTemplate {
    markdownRemark(frontmatter: { templateKey: { eq: "berlinde-page" } }) {
      frontmatter {
        heading
        linkbutton
        howitworks {
